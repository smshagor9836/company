            ...
            <div class="content-requirments d-flex justify-content-center">
                <div class="requirments-main-content">
                 ...
                 <form action="{{ url('install/store') }}" method="POST" id="install">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="type" id="type">
                                        <option value="install" style="background-color: black;color: #fff">I Want To Install</option>
                    ...
                    <button type="submit" class="btn btn-primary install-btn f-right">Save & Install</button>
                </form>
                </div>
            </div>
        </div>
