...
<div class="card"  >
    <div class="card-body">
        ...
        <section id="tabs">
           <center> <span class="text-danger text-center"><b>{{ __('Note :') }}</b> {{ __('This Section For Developer Only') }}</span></center>
            <div id="tabs">
               <div class="col-xs-12 ">
                <nav>
                    <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                        ...
                        <a class="nav-item nav-link" id="nav-pusher-tab" data-toggle="tab" href="#nav-pusher" role="tab" aria-controls="nav-pusher" aria-selected="false"><small>Pusher Settings</small></a>
                         ...
                         <a class="nav-item nav-link" id="nav-pusher-tab" data-toggle="tab" href="#nav-zoom" role="tab" aria-controls="nav-zoom" aria-selected="false"><small>Zoom Settings</small></a>
                    ...
                    <div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
                        ...
                        <div class="tab-pane fade" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab">
                            <div class="custom-form">
                                ...
                                <div class="form-group">
                                    <label for="MAIL_FROM_ADDRESS">MAIL_FROM_NAME</label>
                        ...
                        <div class="tab-pane fade" id="nav-zoom" role="tabpanel" aria-labelledby="nav-stripe-tab">
                            <div class="custom-form">
                                <div class="form-group">
                                    <label for="ZOOM_API_KEY">ZOOM_API_KEY</label>
                                    <input type="text" name="ZOOM_API_KEY" id="ZOOM_API_KEY" value="{{ env("ZOOM_API_KEY") }}" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label for="ZOOM_API_SECRET">ZOOM_API_SECRET</label>
                                    <input type="text" name="ZOOM_API_SECRET" id="ZOOM_API_SECRET" value="{{ env("ZOOM_API_SECRET") }}" class="form-control">
                                </div>
                                   <div class="form-group">
                                    <label for="ZOOM_USER_EMAIL">ZOOM_USER_EMAIL</label>
                                    <input type="text" name="ZOOM_USER_EMAIL" id="ZOOM_USER_EMAIL" value="{{ env("ZOOM_USER_EMAIL") }}" class="form-control">
                                </div>

                                
                            </div>
                        </div>
                        <div class="tab-pane fade" id="nav-pusher" role="tabpanel" aria-labelledby="nav-pusher-tab">
                            <div class="custom-form">
                                <div class="form-group">
                                    <label for="PUSHER_APP_ID">PUSHER_APP_ID</label>
                                    <input type="text" name="PUSHER_APP_ID" id="PUSHER_APP_ID" value="{{ env("PUSHER_APP_ID") }}" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label for="PUSHER_APP_KEY">PUSHER_APP_KEY</label>
                                    <input type="text" name="PUSHER_APP_KEY" id="PUSHER_APP_KEY" value="{{ env("PUSHER_APP_KEY") }}" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label for="PUSHER_APP_SECRET">PUSHER_APP_SECRET</label>
                                    <input type="text" name="PUSHER_APP_SECRET" id="PUSHER_APP_SECRET" value="{{ env("PUSHER_APP_SECRET") }}" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label for="PUSHER_APP_CLUSTER">PUSHER_APP_CLUSTER</label>
                                    <input type="text" name="PUSHER_APP_CLUSTER" id="PUSHER_APP_CLUSTER" value="{{ env("PUSHER_APP_CLUSTER") }}" class="form-control">
                                </div>
                            </div>
                        </div>
        ...
        <button class="btn col-12" type="submit">Change Settings</button>
    </form>
</div>
</div>
</div>
