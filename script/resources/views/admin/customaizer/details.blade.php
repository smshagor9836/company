...
<form action="{{ route('admin.customaizer.image_upload') }}" id="img_form" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="header-top-info single_header d-flex">
        <span  onclick="arrow()" class="arrow_left"><i class="fas fa-chevron-left"></i></span>
        <span>{{ $option['name'] }}</span>
    </div>
    <input type="hidden" id="value_update" value="{{ route('admin.customaizer.value_update') }}">
    <div class="main-sidebar-area">
        ...
        <div class="custom-form">
            ...
            <div class="form-group imgUp">
                ...
                <input type="hidden" id="image_upload_url" value="{{ route('admin.customaizer.image_upload',$settings['id']) }}">
                    ...
                    <div id="{{ $content['id'] }}" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
                        <div class="card-body">
                            <div class="custom-form">
                                ...
                                @endif
                                @endforeach
                                <input type="hidden" id="multiple_settings_option" value="{{ route('admin.customaizer.multiple_settings_option') }}">
                            </div>
                        </div>
                    </div>
                </div>
