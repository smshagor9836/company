...
<div class="row">
	<div class="col-md-12">
		<div class="card">
			<div class="card-body">
				<h4 class="mb-20">Edit Category</h4>
				<div class="row">
					<div class="col-lg-12">
						...
						<form method="post" id="basicform" class="custom-form" action="{{ route('admin.service.category.update',$info->id) }}">
							@csrf
							@method('PUT')
								...
								<div class="form-group">
									...
									<select class="custom-select mr-sm-2" name="p_id" id="p_id">
										<option value="">None</option>
										 <?php echo ConfigCategory(8,$info->p_id) ?>
