		...
		<div class="row mb-30">
			...
			<div class="col-lg-6">
				<div class="add-new-btn">
					<a href="{{ route('admin.faq.create') }}" class="btn f-right">{{ __('Add New') }}</a>
				</div>
			</div>
		</div>
		
		<div class="card-action-filter">
			<form method="post" id="basicform" action="{{ route('admin.faqs.destroy') }}">
				@csrf
				<div class="row">
					<div class="col-lg-6">
						<div class="d-flex">
				...
				<table class="table">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<img src="{{ asset($json->image) }}" height="50">
							</td>
							<td>
								{{ $json->title }}
								<div >
									<a href="{{ route('admin.faq.edit',$post->id) }}">Edit</a>
